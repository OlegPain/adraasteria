(() => {
  ...
  const V = {
    loopCreate: function () {
      ...
      for (let e = 0; e < a.length; e += 1)
        n.append(y(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = o.length - 1; e >= 0; e -= 1)
        n.prepend(y(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
    ...
    t({
      ...
      s("click", (t, s) => {
        const { $nextEl: n, $prevEl: r } = e.navigation,
          o = s.target;
        if (e.params.navigation.hideOnClick && !y(o).is(r) && !y(o).is(n)) {
          if (
            e.pagination &&
            e.params.pagination &&
  ...
  window.addEventListener("load", function (e) {
    de(),
      document.querySelector(".services_slider") &&
        new ae(".services_slider", {
          modules: [le],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          breakpoints: {
            20: { slidesPerView: 1, spaceBetween: 100, autoHeight: !0 },
            768: { slidesPerView: 2, spaceBetween: 20 },
            992: { slidesPerView: 3, spaceBetween: 20 },
            1468: { slidesPerView: 4, spaceBetween: 30 },
          },
          on: {},
        });
  });
  ...
  setTimeout(() => {
    ...
    (window.onload = function () {
      document.body.classList.add(".background_animation"),
  ...
  document.querySelector(".header-scrollbar");
  window.addEventListener("scroll", function () {
    window.pageYOffset > 5
      ? pe.classList.add("header-scroll")
      : window.pageYOffset < 5 && pe.classList.remove("header-scroll");
  });
  document.querySelector(".header-scrollbar");
  const ue = document.querySelector(".site-title-animation-text"),
    he = document.querySelectorAll(".icons-animated");
  window.addEventListener("scroll", function () {
    for (let e = 0; e < he.length; e++)
      window.pageYOffset > 1e3
        ? (he[e].classList.remove("animated"),
          ue.classList.remove("animatedText"))
        : window.pageYOffset < 1e3 &&
          (he[e].classList.add("animated"), ue.classList.add("animatedText"));
  });
  const fe = document.querySelector(".menu_burger");
  if (fe) {
    const e = document.querySelector(".menu_body_wrap"),
      t = document.querySelector(".menu_body");
    fe.addEventListener("click", function (s) {
      fe.classList.toggle("menu-open"),
        e.classList.toggle("_active-menu"),
        t.classList.toggle("_active-menu");
    });
  }
  const me = document.querySelectorAll(".btn-check");
  for (let e = 0; e < me.length; e++)
    me[e].addEventListener("click", function (t) {
      me[e].classList.toggle("active");
    });
  const ge = document.querySelectorAll(
      ".work-content-box-contain-item-img-icon"
    ),
    ve = document.querySelectorAll(".work_title-box-item"),
    we = document.querySelectorAll(".work-content-box-contain-item");
  for (let e = 0; e < ve.length; e++)
    ve[e].addEventListener("mouseover", function (t) {
      ge[e].classList.add("animated-active"), we[e].classList.add("_active");
    }),
      ve[e].addEventListener("mouseout", function (t) {
        ge[e].classList.remove("animated-active"),
          we[e].classList.remove("_active");
      });
  const be = document.querySelectorAll(".__block"),
    Se = document.querySelectorAll(".menu_category");
  for (let e = 0; e < Se.length; e++)
    Se[e].addEventListener("click", () => {
      gsap.to(window, { duration: 1, scrollTo: { y: be[e], offsetY: 100 } });
    });
  gsap.registerPlugin(ScrollTrigger),
    gsap.from(".site-title-block__container", {
      scrollTrigger: ".site-title-block__container",
      duration: 1.2,
      delay: 3,
      opacity: 0,
    }),
    gsap.from(".about_block", {
      scrollTrigger: ".about-content-box",
      duration: 1.2,
      opacity: 0,
    }),
    gsap.from(".services_block__container", {
      scrollTrigger: ".services_block__container",
      duration: 1.2,
      delay: 0.3,
      opacity: 0,
    }),
    gsap.from(".clients_block__container", {
      scrollTrigger: ".clients_block",
      duration: 1.1,
      y: 1e3,
    }),
    (window.FLS = !0),
